                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<c:url value='/groupwork-add'/>" method="post">
                                <div class="form-group" >
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name='project-name'>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Mô tả dự án</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name='project-description'>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input type="datetime-local" class="form-control form-control-line" name='project-start-date'> 
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name='project-id-manager'>
